...
:: Restore packages and build the application
    ...
    call dotnet build src --configuration %CONFIGURATION%
    IF %ERRORLEVEL% NEQ 0 GOTO FAIL
...
:: Build the container image
    ...
    rmdir /s /q rc\WebService\bin\Docker

    mkdir out\docker\webservice

    dotnet publish src\WebService      --configuration %CONFIGURATION% --output bin\Docker

    xcopy /s bin\Docker\*       out\docker\webservice\
